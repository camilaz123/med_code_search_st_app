...
def install_and_import():
    try:
        ...
        importlib.import_module("med_code_search.main")
    except ImportError:
        ...
        if importlib.util.find_spec("med_code_search.main") is not None:
            globals()["med_code_search.main"] = importlib.import_module("med_code_search.main")
        else:
            print(f"Failed to install and import med_code_search.main")

install_and_import()

# Here comes the code that will only run if numpy is installed.
if 'med_code_search.main' in globals():
    import med_code_search.main as main
    main.app()